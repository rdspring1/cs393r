...
const float GOAL_Y = 1604;
const float GOAL_POST_WIDTH = 98;
const float GOAL_WIDTH = GOAL_Y + GOAL_POST_WIDTH;
const float GOAL_X = 562;
const float HALF_GOAL_Y = GOAL_Y / 2.0;
const float PENALTY_Y = 2204;
const float PENALTY_X = 595;
const float CIRCLE_DIAMETER = 1508;
const float CIRCLE_RADIUS = CIRCLE_DIAMETER / 2.0; 
const float LINE_WIDTH = 49;

const float GOAL_HEIGHT = 896;

const float FIELD_CENTER_X = 0;
const float FIELD_CENTER_Y = 0;

const float PENALTY_CROSS_X = HALF_FIELD_X - 1807;
const float PENALTY_MARK_SIZE = 97;
